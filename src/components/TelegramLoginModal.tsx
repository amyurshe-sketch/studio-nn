...
export default function TelegramLoginModal({ open, onClose, botUsername }: Props) {
  ...
  useEffect(() => {
    ...
    window.onTelegramAuth = async (user: any) => {
      try {
        ...
        console.error(e);
        alert('Не удалось войти через Telegram. Проверьте настройки бота.');
      }
    };
  ...
  }, [open, bot, navigate, onClose, language]);
