...
const resources: Resources = {
  ru: {
    ...
    'register.password.placeholder': 'Не менее 3 символов',
    ...
    'register.error.short': 'Пароль должен быть не менее 3 символов',
  ...
  en: {
    ...
    'register.password.placeholder': 'At least 3 characters',
    ...
    'register.error.short': 'Password must be at least 3 characters',
